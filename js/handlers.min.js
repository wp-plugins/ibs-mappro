...
if("kml"===b||"kmz"===b||"gpx"===b)b=a.html["upload-dialog"].find(".upload-target-directory").val(),b=ibs_mappro.maps_url+b,a.file.importFile(b+c)});this.html.data.on("click",".chart-close",{map:this},function(a){a.data.map.elevationSegment=null;a.data.map.sizeHtml()});this.html["file-dialog"].find(".reset-lines").button({text:!0,label:"Set Lines",icons:{primary:"ui-icon-arrowreturnthick-1-e"}});this.html["upload-dialog"].on("change",".upload-target-directory",{map:this},function(a){a=a.data.map;
